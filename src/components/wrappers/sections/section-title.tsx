  ...
  return (
    <div className={clsx('content-wrapper')}>
      <m.h1
        ...
        className={clsx(
          'text-[#b7004a] tracking-wide text-2xl mb-2 block font-black',
          'lg:mb-4',
      ...
      {button && (
        <m.div
          ...
          <Link href={button.href} target="_blank" className={clsx('inline-flex h-10 items-center justify-center gap-1.5 rounded-md border border-transparent px-4 text-center text-sm font-bold transition duration-150',
            'md:rounded-xl', 'bg-accent-600/[0.08] text-accent-600 rounded-full px-5 font-bold', 'dark:bg-accent-400/10 dark:text-accent-100 dark:font-semibold hover:dark:bg-[#980341]/100 hover:dark:text-slate-100 hover:text-slate-900')}>
            {button.title}
