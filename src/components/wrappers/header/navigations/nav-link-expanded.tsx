...
const NavLinkExpanded = ({ title, items }: NavLinkExpandedProps) => {
  return (
    <div className={clsx('flex')}>
      <div
        className={clsx(
          'text-accent-600 flex h-9 items-center gap-1 rounded-xl px-2 text-[13px] font-bold dark:text-accent-400 dark:font-semibold hover:text-accent-700 hover:dark:text-accent-300 pointer-events-none ml-2 mr-2', 'bg-[#fe0a79]/[0.08] text-[#980341] rounded-full px-5 dark:bg-accent-400/10 '
        )}
      >
        {title}
