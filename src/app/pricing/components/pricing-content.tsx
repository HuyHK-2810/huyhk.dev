        ...
        <section className="relative">
            <Container>
                <div className="py-20 flex flex-col gap-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
                        {packages.map((pkg) => (
                            <div key={pkg.id} className={clsx(
                                'group relative rounded-2xl p-7 transition-all duration-300 cursor-pointer',
                                'hover:scale-[1.02] hover:shadow-glow',
                                'glass glass-hover border border-white/8',
                                ...
                                <div className="mb-6">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        {pkg.originalPrice && (
                                            <div className="px-3 py-1 bg-red-500/15 text-red-400 rounded-full text-sm font-bold border border-red-500/20">
                                                Giảm giá
                                            </div>
                                        )}
                                    </div>
                                ...
                                <ul className="space-y-3 mb-8">
                                    ...
                                    {pkg.features.length > 5 && (
                                        <li className="text-white/40 text-sm font-medium">
                        ...
                        <div className="relative glass rounded-2xl p-8 border border-white/8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                                {addOns.map((addon, index) => (
                                    <div key={index} className="group glass glass-hover rounded-2xl p-6 border border-white/8 transition-all duration-300">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative text-center glass rounded-2xl p-12 border border-white/8">
            ...
            {selectedPackage && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-[1001]">
                    <div className="bg-dark-100/95 backdrop-blur-2xl rounded-2xl max-w-5xl w-full max-h-[90vh] border border-white/10 shadow-glass-lg flex flex-col">
                        <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
                            <div className="p-8">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    {/* Project Details */}
                                    <div className="space-y-6">
                                        <div className="p-6 bg-indigo-500/8 rounded-2xl border border-indigo-500/15">
                                ...
                                <div className="mt-8 pt-6 border-t border-white/8">
                                    <div className="flex flex-col sm:flex-row gap-4">
                                        ...
                                        <Button variant="outline" onClick={() => setSelectedPackage(null)} className="border border-indigo-500/30 hover:border-indigo-400/50 text-indigo-300 hover:bg-indigo-500/10 px-8 py-3 rounded-xl font-semibold">
                                            Đóng
                                        </Button>
                                    </div>
                                </div>
                            ...
                            <form onSubmit={handleContactSubmit} className="space-y-6">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    <Button
                                        ...
                                        variant="outline"
                                        onClick={() => setShowContactForm(false)}
                                        className="border border-indigo-500/30 hover:border-indigo-400/50 text-indigo-300 hover:bg-indigo-500/10 px-8 py-3 rounded-xl font-semibold"
                                    >
                                        Hủy
                                    </Button>
                                </div>
